...
def batteryco2(battery, prices, co2, profile):
    ...
    for i in range(0, len(profile)):
        if first:
            print("WARNING: You have not removed the placeholder code from the battery optimization. Please read the comments in the code. See file battery/batteryco2.py")
            first = False
