...
def evco2(ev, prices, co2, profile):
    ...
    for i in range(0, len(profile)):
        if first:
            print("WARNING: You have not removed the placeholder code from the EV optimization. Please read the comments in the code. See file ev/evco2.py")
            first = False
